...
class CLVPredictor:
    ...
    def _find_existing_customer(self, customer_name: str) -> Optional[CustomerProfile]:
    ...
    def get_clv_prediction(self, prediction_id: str) -> Optional[CLVPrediction]:
    ...
    def get_top_value_customers(self, limit: int = 10) -> List[Tuple[CustomerProfile, Optional[CLVPrediction]]]:
