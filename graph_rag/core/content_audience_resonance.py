...
from graph_rag.core.audience_intelligence import (
    AudienceSegment, AudiencePersona, DemographicProfile, BehaviorProfile,
    PsychographicProfile, AgeGroup, Industry, ExperienceLevel, PersonalityTrait,
    ContentPreference, EngagementType, Platform
)
...
class DemographicResonanceAnalyzer:
    ...
    async def _analyze_location_alignment(self, content: str, location: Optional[str]) -> float:
    ...
    async def _generate_demographic_optimizations(
        ...
        if resonance.industry_alignment < 0.6 and demo_profile.industry:
            ...
            recommendations.append(f"Reference industry-relevant examples and case studies")
...
class BehavioralResonanceAnalyzer:
    ...
    async def _analyze_timing_fit(
        ...
        optimal_hours: Optional[List[int]]
    ) -> float:
