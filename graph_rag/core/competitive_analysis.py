...
from graph_rag.core.audience_intelligence import (
    AudienceSegment, AudiencePersona, AudienceSegmentationEngine,
    DemographicProfile, BehaviorProfile, PsychographicProfile,
    ContentPreference, PersonalityTrait, Industry, ExperienceLevel
)
...
class CompetitorProfile:
    ...
    engagement_pattern: Optional[EngagementPattern] = None
...
class ContentAnalyzer:
    ...
    async def _identify_content_strategy(self, content_samples: List[Dict[str, Any]]) -> Optional[ContentStrategy]:
    ...
    def _identify_engagement_pattern(self, posting_freq: float, avg_engagement: float,
                                   viral_percentage: float, content_samples: List[Dict[str, Any]]) -> Optional[EngagementPattern]:
...
class MarketGapAnalyzer:
    ...
    async def identify_market_gaps(self, competitor_profiles: List[CompetitorProfile],
                                 our_content_strategy: Optional[Dict[str, Any]] = None) -> List[MarketGap]:
    ...
    async def _identify_content_gaps(self, competitor_profiles: List[CompetitorProfile],
                                   our_strategy: Optional[Dict[str, Any]]) -> List[MarketGap]:
...
class CompetitiveAnalyzer:
    ...
    async def analyze_competitive_landscape(self, 
                                          ...
                                          our_content_strategy: Optional[Dict[str, Any]] = None,
                                          analysis_scope: Optional[Dict[str, Any]] = None) -> CompetitiveAnalysisResult:
    ...
    def _classify_competitor_type(self, profile: CompetitorProfile, 
                                our_strategy: Optional[Dict[str, Any]]) -> CompetitorType:
    ...
    def _identify_performance_gaps(self, competitor_profiles: List[CompetitorProfile],
                                 our_strategy: Optional[Dict[str, Any]]) -> Dict[str, float]:
...
async def analyze_competitor_landscape(competitor_data: Dict[str, List[Dict[str, Any]]],
                                     our_strategy: Optional[Dict[str, Any]] = None) -> CompetitiveAnalysisResult:
