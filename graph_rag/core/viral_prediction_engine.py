...
class ViralPrediction(BaseModel):
    ...
    optimal_posting_time: Optional[datetime] = Field(default=None, description="Suggested posting time")
...
class ViralPredictionEngine:
    ...
    def _calculate_optimal_posting_time(self, temporal_factors: TemporalFactors) -> Optional[datetime]:
