...
class MitigationStrategy:
    ...
    decision_deadline: Optional[datetime] # When decision must be made
...
class BrandSafetyAssessment(BaseModel):
    ...
    viral_prediction: Optional[ViralPrediction] = Field(default=None, description="Associated viral prediction")
