...
class DemographicProfile:
    ...
    job_level: ExperienceLevel | None = None
...
class BehaviorProfile:
    ...
    content_length_preference: str | None = None  # short, medium, long
    media_preferences: dict[str, float] = field(default_factory=dict)  # text, image, video
    interaction_style: str | None = None  # lurker, commenter, sharer, creator
    response_time: float | None = None  # average response time in hours
    confidence: float = 0.0
...
class DemographicAnalyzer:
    ...
    def _extract_location(self, text: str, context: dict[str, Any] = None) -> str | None:
