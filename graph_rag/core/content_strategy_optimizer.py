...
class ContentGapAnalyzer:
    ...
    def _map_media_type_to_format(self, media_type: str) -> Optional[ContentFormat]:
...
class StrategicPlanner:
    ...
    async def _create_milestone_timeline(self, 
        ...
        for week in [4, 8, 12]:
            ...
            review_milestone = StrategicMilestone(
                ...
                description=f"Comprehensive performance review and strategy optimization",
    ...
    async def _set_kpi_targets(self, calendar: ContentCalendar, 
        ...
        calendar.current_progress = {kpi: 0.0 for kpi in calendar.kpi_targets.keys()}
