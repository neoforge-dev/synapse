...
class SimpleGraphRAGEngine(GraphRAGEngine):
    ...
    async def _find_entities_in_graph_by_properties(self, entities_from_extractor: List[Entity]) -> List[Entity]:
        ...
        for entity in entities_from_extractor:
            ...
            search_key = (entity.name, entity.label)
            if not entity.name or not entity.label or search_key in processed_extractor_entities:
            ...
            search_props = {"name": entity.name, "type": entity.label}
            ...
            if include_graph_context:
                ...
                if extracted_entities:
                    ...
                    if seed_entities:
                        ...
                        # Explicitly set graph_context_tuple to indicate search but no seeds found
                        graph_context_tuple = ([], []) 
                else:
