...
from .tenant_manager import TenantConfiguration, TenantStatus, TenantType, TenantManager
from .data_isolation import TenantDataManager, IsolationLevel
from .resource_isolation import TenantResourceManager, QoSLevel
...
class TenantProvisioningEngine:
    ...
    async def _handle_resource_config(self, status: ProvisioningStatus) -> OnboardingResult:
        ...
        try:
            ...
            status.stage_logs[ProvisioningStage.RESOURCE_CONFIG] = [
                ...
                f"CPU limit: varies by QoS",
                f"Memory limit: varies by QoS",
    ...
    def get_provisioning_status(self, tenant_id: str) -> Optional[ProvisioningStatus]:
