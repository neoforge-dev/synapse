...
class TenantManager:
    ...
    def __init__(self):
        ...
        self._consultation_tenant_id: Optional[str] = None  # Epic 7 protection
    ...
    def detect_tenant_from_request(self, request: Request) -> Optional[str]:
    ...
    def create_tenant_context(self, tenant_id: str) -> Optional[TenantContext]:
    ...
    def validate_tenant_access(self, tenant_id: str, required_feature: Optional[str] = None) -> bool:
        ...
        if not context or context.tenant_id != tenant_id:
            logger.warning(f"Tenant access validation failed - context mismatch")
            return False
