...
class ResourceMonitor:
    ...
    def _get_recent_usage(self, tenant_id: str) -> Optional[ResourceUsage]:
    ...
    def get_tenant_alerts(self, tenant_id: str, severity: Optional[str] = None) -> List[ResourceAlert]:
...
class ResourceThrottler:
    ...
    async def _check_api_rate_limit(self, tenant_id: str, calls: float) -> Tuple[bool, Optional[str]]:
    ...
    async def _check_concurrent_requests(self, tenant_id: str, requests: float) -> Tuple[bool, Optional[str]]:
    ...
    async def _check_db_connections(self, tenant_id: str, connections: float) -> Tuple[bool, Optional[str]]:
...
class TenantResourceManager:
    ...
    def get_tenant_limits(self, tenant_id: str) -> Optional[ResourceLimits]:
        """Get resource limits for tenant."""
        return self._tenant_configs.get(tenant_id)


# Global resource manager instance
_resource_manager: Optional[TenantResourceManager] = None
