...
from graph_rag.infrastructure.multi_tenancy.tenant_isolation import (
    SecureTenantRepository, TenantContext, TenantIsolationError
)
...
from security.encryption import DataEncryptionManager, FieldLevelEncryption
from security.key_management import VaultKeyManager, VaultConfig
from security.zero_trust import ZeroTrustAccessControl, AccessLevel, ResourceType
...
class EncryptedTenantRepository(SecureTenantRepository):
    ...
    async def read(self, entity_id: str, identity=None) -> Optional[Dict[str, Any]]:
