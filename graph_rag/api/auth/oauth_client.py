...
from .enterprise_sso import SSOProvider, OIDCTokenResponse
...
class OIDCUserInfo(BaseModel):
    ...
    hd: Optional[str] = None  # Hosted domain
...
class EnterpriseOAuthClient:
    ...
    def create_authorization_url(self, provider: SSOProvider, redirect_uri: str, 
                               scopes: Optional[List[str]] = None, use_pkce: bool = True) -> tuple[str, OAuthState]:
    ...
    def map_oidc_user_to_synapse_user(self, userinfo: OIDCUserInfo, id_token: Optional[IDTokenClaims],
