...
from .enterprise_sso import EnterpriseSSOHandler, SSOProvider, SAMLResponse, SSOSession
from .oauth_client import EnterpriseOAuthClient, OIDCUserInfo, IDTokenClaims, OIDCTokenResponse
...
class EnterpriseAuthResult:
    ...
    def __init__(self, success: bool, user: Optional[User] = None, 
                 error: Optional[str] = None, session: Optional[SSOSession] = None,
...
class MultiProviderSSOService:
    ...
    async def get_tenant_configuration(self, tenant_id: str) -> Optional[TenantConfiguration]:
    ...
    async def complete_saml_login(self, saml_response_b64: str, provider_id: str,
                                relay_state: Optional[str] = None) -> EnterpriseAuthResult:
    ...
    async def get_enterprise_analytics(self, tenant_id: Optional[str] = None) -> Dict[str, Any]:
