...
from graph_rag.core.interfaces import GraphRepository, DocumentData, ChunkData
...
class AutonomousKnowledgeGraphBuilder:
    ...
    def __init__(
        ...
        pattern_analyzer: Optional[DataPatternAnalyzer] = None,
        schema_generator: Optional[AdaptiveSchemaGenerator] = None,
        ...
        # Operational state
        self.current_schema: Optional[GraphSchema] = None
