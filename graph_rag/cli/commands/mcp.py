...
def start_server(
    ...
    api_url: Optional[str] = typer.Option(None, "--api-url", help="Synapse API base URL"),
...
def info():
    ...
    try:
        ...
        console.print(f"[bold]Synapse GraphRAG MCP Server[/bold]")
...
@app.command("test")
def test_tools(
    tool: Optional[str] = typer.Option(None, "--tool", "-t", help="Test specific tool (ingest_files, search, query_answer)"),
    api_url: Optional[str] = typer.Option(None, "--api-url", help="Synapse API base URL"),
):
