...
class SavedQueryManager:
    ...
    def search_queries(self, search_term: str, user_id: str | None = None) -> list[dict[str, Any]]:
    ...
    def duplicate_query(self, query_id: str, new_name: str, user_id: str) -> str | None:
