        ...
        for pattern_name, pattern_info in self.architectural_patterns.items():
            ...
            if keyword_matches > 0:
                ...
                pattern = ArchitecturalPattern(
                    ...
                    description="Architectural pattern identified from content analysis",
...
class SynapseExperimentConsolidator(ExperimentConsolidator):
    ...
    async def _create_candidate_from_file(self, file_path: Path) -> ConsolidationCandidate | None:
