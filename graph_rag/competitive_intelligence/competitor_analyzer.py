...
class CompetitorProfile:
    ...
    pricing_model: str = ""
    pricing_range: Optional[Tuple[float, float]] = None
    ...
    brand_recognition: Optional[float] = None
...
class CompetitorAnalyzer:
    ...
    async def _collect_basic_competitor_info(self, competitor_name: str) -> Dict[str, Any]:
        ...
        if self.web_scraper:
            try:
                ...
                scraped_data = {
                    "description": f"Technology company specializing in enterprise solutions",
    ...
    def get_analysis_result(self, analysis_id: str) -> Optional[CompetitiveAnalysisResult]:
