...
class TenantConfiguration(BaseModel):
    ...
    gdpr_processing_basis: str | None = None
...
class EnterpriseConfigManager:
    ...
    def _log_audit_event(self, tenant_id: str | None, action: str, resource_type: str,
                        resource_id: str | None = None, old_values: dict | None = None,
                        new_values: dict | None = None, user_id: str | None = None) -> None:
    ...
    def create_enterprise_client(self, client_data: EnterpriseClient, user_id: str | None = None) -> None:
    ...
    def get_enterprise_client(self, client_id: str) -> EnterpriseClient | None:
    ...
    def create_tenant_configuration(self, tenant_config: TenantConfiguration, user_id: str | None = None) -> None:
    ...
    def get_tenant_configuration(self, tenant_id: str) -> TenantConfiguration | None:
    ...
    def update_tenant_configuration(self, tenant_id: str, updates: dict[str, Any], user_id: str | None = None) -> bool:
    ...
    def register_sso_provider(self, provider: SSOProvider, user_id: str | None = None) -> None:
    ...
    def get_compliance_audit_log(self, tenant_id: str | None = None,
