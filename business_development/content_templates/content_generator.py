...
from .synapse_enricher import EnrichedContent, SynapseContentEnricher
from .templates import ContentTemplate, ContentTemplates, ContentType
...
class LinkedInContentGenerator:
    ...
    def _generate_hook(self, template: ContentTemplate, topic: str,
                      enriched_content: EnrichedContent, specific_angle: str | None) -> str:
    ...
    def _generate_cta(self, template: ContentTemplate, topic: str,
        ...
        if template.content_type in [ContentType.PRODUCT_MANAGEMENT, ContentType.STARTUP_LESSONS]:
            ...
            ctas = [
                ...
                "Have you seen this pattern in your work?"
            ]
            return random.choice(ctas)
        else:
