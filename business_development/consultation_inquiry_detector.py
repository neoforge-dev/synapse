...
from linkedin_posting_system import LinkedInBusinessDevelopmentEngine, ConsultationInquiry
...
class ConsultationInquiryDetector:
    ...
    def analyze_text_for_consultation_signals(self, text: str, source_post_id: str) -> Optional[Tuple[str, int, int]]:
        """
    ...
    def process_linkedin_comment(self, post_id: str, comment_text: str, commenter_name: str, commenter_profile: str = "") -> Optional[str]:
    ...
    def process_linkedin_dm(self, post_id: str, dm_text: str, sender_name: str, sender_company: str = "") -> Optional[str]:
    ...
    def generate_follow_up_response(self, inquiry_id: str) -> Dict[str, str]:
        ...
        inquiry = dict(zip(columns, result))
        conn.close()
        
        # Generate response based on inquiry type
        response_templates = {
            "team_building": {
                "comment_reply": f"Thanks for the comment! Team velocity challenges are common when scaling. I've helped several companies go from inconsistent delivery to predictable sprint outcomes. Happy to share some specific approaches if you'd like to continue the conversation via DM.",
            ...
            "fractional_cto": {
                "comment_reply": f"Appreciate the interest in fractional CTO services! I work with companies at various stages to provide strategic technical leadership without the full-time commitment. Feel free to DM me to discuss your specific technical leadership needs.",
            ...
            "nobuild_audit": {
                "comment_reply": f"Great question about build vs buy decisions! The #NOBUILD approach has saved companies significant engineering time and costs. I'd be happy to discuss how to apply this framework to your specific technology decisions - feel free to DM me.",
            ...
            "general_consultation": {
                "comment_reply": f"Thanks for the comment! I'd be happy to discuss this further. Feel free to send me a DM and we can explore how to apply these concepts to your specific situation.",
...
def main():
    ...
    print(f"Ready to monitor LinkedIn engagement and automatically detect consultation opportunities.")
