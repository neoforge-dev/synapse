...
class EncryptionPolicy:
    ...
    @classmethod
    def get_policy_for_document(cls, document: dict[str, Any]) -> str | None:
...
class DataEncryptionManager:
    ...
    def encrypt_document(self, document: dict[str, Any],
                        ...
                        server_public_key: bytes | None = None) -> dict[str, Any]:
    ...
    def _encrypt_auto_mode(self, document: dict[str, Any], policy_name: str,
                          client_id: str | None, server_public_key: bytes | None) -> dict[str, Any]:
