...
generate_essay_structure() {
    ...
    # Get essay date
    local essay_date
    essay_date=$(date -d "2025-01-01 +$((week_number-1)) weeks" +%Y-%m-%d)
    
    # Generate structured essay framework
    cat > "$CONTENT_OUTPUT_DIR/week_${week_number}_${essay_title,,}.md" <<EOF
# $essay_title
...
EOF
    ...
    log_success "Essay structure generated: week_${week_number}_${essay_title,,}.md"
}
...
generate_content_package() {
    ...
    case $week_number in
        1) 
            ...
            generate_social_snippets 1 "$CONTENT_OUTPUT_DIR/week_1_the cli-first productivity revolution.md"
            ;;
        2)
            generate_essay_structure 2 "Building Your Personal AI Research Team" "AI research automation intelligence gathering"  
            generate_social_snippets 2 "$CONTENT_OUTPUT_DIR/week_2_building your personal ai research team.md"
            ;;
        3)
            ...
            generate_social_snippets 3 "$CONTENT_OUTPUT_DIR/week_3_from notion to obsidian to cli knowledge management.md"
            ;;
        *)
