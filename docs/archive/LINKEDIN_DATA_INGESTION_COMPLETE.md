...
> **Note:** This document captures a historical plan and may not reflect the current production state. Treat the targets below as aspirational checkpoints rather than guaranteed deliverables.
...
curl http://localhost:18888/api/v1/admin/vector/stats  # API perspective
